...
public class UserServiceImpl implements UsersService {
	...
	public UserDto getUserByUserId(String userId)  {
		...
		ResponseEntity<List<AlbumsResponseModel>> listAlbums = restTemplate.exchange(albumsUrl 				
						,HttpMethod.GET
						,null//@@ [IF METADATA IS NULL]
				        ,new ParameterizedTypeReference<List<AlbumsResponseModel>>() {			   		 
			   	 });
		
		//@@ EXTRACT LISTS OF ALMUBS VIA getBody() METHOD AND ASSIGN IT TO OBJECT OF ALBUMRESPONSEMODEL OF TYPE LIST 
